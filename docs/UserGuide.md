...
Both `START_DATETIME` and `END_DATETIME` are optional. If only `START_DATETIME` is provided, all appointments that is occurring on or after the `START_DATETIME` will be shown. If only `END_DATETIME` is provided, all appointments that is occurring on or before the `END_DATETIME` will be shown.
...
* `filter sd/2022-12-12 12:00` shows all appointments that is occurring on or after 12pm on 12 December 2022. This includes any appointments that start before 12pm and end after 12pm.
* `filter ed/2022-12-12 14:00` shows all appointments that is occurring on or before 2pm on 12 December 2022. This includes any appointments that start before 2pm and end after 2pm.
