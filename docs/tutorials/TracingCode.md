...
1. _Step into_ the line where user input in parsed from a String to a Command, which should bring you to the `CommandParser#parseCommand()` method (partial code given below):
   ```java
